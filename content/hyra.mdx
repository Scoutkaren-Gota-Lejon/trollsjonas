...
import PriceCalc from "../src/components/PriceCalc";
...
<h3 className="priceheading">Lägeranläggningen</h3>
...
## Hyresvillkor
* <a target="_blank" rel="noreferrer" className="pricelink" href="/hyresavtal.pdf">Hyresavtal lägergården Trollsjönäs</a>
* <a target="_blank" rel="noreferrer" className="pricelink" href="/hyresavtal-kanoter.pdf">Hyresavtal kanoter</a>
